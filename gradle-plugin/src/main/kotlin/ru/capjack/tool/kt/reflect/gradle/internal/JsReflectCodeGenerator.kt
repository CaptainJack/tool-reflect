...
class JsReflectCodeGenerator(
	...
	private val factory = getReference(context.currentModule.resolveClassByFqName(FqName("ru.capjack.tool.kt.reflect.Reflections"), NoLookupLocation.FROM_BACKEND)!!)
